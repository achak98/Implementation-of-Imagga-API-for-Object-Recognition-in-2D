...
class ImaggaAPI:
    def __init__(self):
        self.api_key = 'acc_e51518971da9205'
        self.api_secret = 'd9b80903288c46ce81d984851563d61e'
        self.threshold = 20
        self.language = "en"
...
def main():
    ...
    if not (hasTags and args.skipIfTagged):
        ...
        max = 0
        print("the most probable 5 predictions (rankwise) are:",end='\n')
        for ind in range(5):
            print (ind+1, ".    "+tags[ind]['tag']['en'])
        ...
        print("The background colors detected are as follows: ", end='\n')
        ind = 1
        for bgcol in colors["background_colors"]:
            print(ind, ".   " + bgcol['closest_palette_color'])
            ind+=1
        print("The foreground colors detected are as follows: ", end='\n')
        ind = 1
        for bgcol in colors["foreground_colors"]:
            print(ind, ".   " + bgcol['closest_palette_color'])
            ind += 1
        print("The image colors detected are as follows: ", end='\n')
        ind = 1
        for bgcol in colors["image_colors"]:
            print(ind, ".   " + bgcol['closest_palette_color'])
            ind += 1
